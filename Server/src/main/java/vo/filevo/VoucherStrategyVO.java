...
public class VoucherStrategyVO implements Serializable {
    ...
    public VoucherStrategyVO(String id,FileState state,FileType type,String creator,Map<Double,Double> content,boolean isUsing,
