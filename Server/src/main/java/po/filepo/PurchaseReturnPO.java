...
/*
 * @Name PurchaseReturnPO
 * @Description 采购退货单
 * @author zhangping
 * @date 2017/12/26 0026 16:06
 *
 */
public class PurchaseReturnPO{
    ...
    private double total;//退货商品总价
    private Set<Infor> information;//单据的经手信息

    /*public PurchaseReturnPO(String ID,FileType type,String operator,String clerk, String note, String createTime, String passTime, FileState state, String client,String warehouse, Set<ProductItem> products, double total,Set<String> infor){
