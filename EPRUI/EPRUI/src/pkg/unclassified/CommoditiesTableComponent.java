...
public class CommoditiesTableComponent extends VBox {
    ...
    //    dataList.clear();
       ...
       // quantityColumn.setReorderable(false);
        ...
        double unitPriceColumnWidthRate=0.1;
        ...
        double totalPriceColumnWidthRate=0.1;
       ...
       // remarkColumn.setReorderable(false);
        ...
        tableView.getColumns().addAll(emptyColumn,commodityIdColumn,nameColumn,quantityColumn,unitPriceColumn,totalPriceColumn,remarkColumn,deleteButtonColumn,warningColumn);
