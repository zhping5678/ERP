...
public class WarehouseImageController {
    ...
    public void Clicked(MouseEvent mouseEvent) {
        ...
        if(warehouse.hasChildren(namelW.getText())){
            String[] children=warehouse.getChildren(namelW.getText());
    ...
    public void Entered(MouseEvent mouseEvent) {
        namelW.setFont(Font.font(20));
    }

    public void Exited(MouseEvent mouseEvent) {
        namelW.setFont(Font.font(18));
    }
}
