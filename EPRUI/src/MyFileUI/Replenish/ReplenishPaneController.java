...
public class ReplenishPaneController {
    ...
    public void Clicked3(MouseEvent mouseEvent) {
        ...
        su.updatePurchaseAndReturn(name.getText(),client.getText(),worker.getText(),ope.getText(),V1,sum,VBoxMessage,"");
    }
    ...
    public void Clicked4(MouseEvent mouseEvent) {
        try {
            ResultMessage r=RemoteHelper.getInstance().getServiceFactory().getSalesmanFileBusinessLogicService().commit(CurrentState.getLoginID(),name.getText());
