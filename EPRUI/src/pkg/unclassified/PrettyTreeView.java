...
public class PrettyTreeView<T> extends TreeView {
    private ScrollBar vBar = new ScrollBar();
    private ScrollBar hBar = new ScrollBar();
    /**************------------------***********/
    /*************ORIGINAL*************/
    public PrettyTreeView(TreeItem treeItem) {
        super(treeItem);
        ...
        /**************------------------***********/
        this.getStylesheets().add("/pkg/stylesheet/PrettyTreeView.css");
        /*************ORIGINAL*************/
        getStyleClass().add("pretty-tree-view");
